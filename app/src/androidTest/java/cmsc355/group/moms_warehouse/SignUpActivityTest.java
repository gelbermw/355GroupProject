...
public class SignUpActivityTest {
    ...
    public void signUpActivityTest() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.Bsignup), withText("SIGNUP"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.TFpass2),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("pasword"), closeSoftKeyboard());

        ViewInteraction appCompatButton10 = onView(
                allOf(withId(R.id.Bsubmit), withText("SUBMIT"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
